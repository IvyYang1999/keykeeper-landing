...
- **Before writing:** the value must look like a Xiaomi MiMo · Pay-as-you-go key (starts with `sk-`, whether it can be viewed again is unconfirmed). A wrong paste is refused before anything is stored, and the agent is told why — without the value.
