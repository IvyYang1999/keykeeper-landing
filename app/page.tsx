    ...
    <div className="min-h-screen bg-[#09090b] text-zinc-100">
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-white text-black font-medium px-6 py-2.5 rounded-md hover:bg-zinc-200 transition-colors text-sm"
            >
              View on GitHub
            </a>
            <a
              href="#install"
              className="border border-white/10 hover:border-white/25 text-zinc-300 px-6 py-2.5 rounded-md transition-colors text-sm font-mono"
            >
      ...
      <section className="py-24 px-6 dot-grid">
        <div className="max-w-5xl mx-auto">
          <h2
            className="text-[10px] tracking-[0.3em] text-zinc-500 text-center mb-12 uppercase"
            style={{ fontFamily: "var(--font-pixel)" }}
          >
            How It Works
          </h2>
      ...
      <section id="install" className="py-24 px-6">
        <div className="max-w-2xl mx-auto text-center">
          <h2
            className="text-[10px] tracking-[0.3em] text-zinc-500 text-center mb-8 uppercase"
            style={{ fontFamily: "var(--font-pixel)" }}
          >
            Install
          </h2>
