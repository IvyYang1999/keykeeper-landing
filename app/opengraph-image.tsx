...
export default function OpenGraphImage() {
  return new ImageResponse(
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between", padding: 72, background: "linear-gradient(135deg, #ffffff 0%, #f5f3ee 58%, #fff4c9 100%)", color: "#171716", fontFamily: "-apple-system, BlinkMacSystemFont, Arial, sans-serif" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 22 }}>
        <div style={{ display: "flex", flexDirection: "column", fontSize: 66, lineHeight: 1.04, letterSpacing: -3, fontWeight: 760 }}>
          ...
          <span style={{ color: "#e6a800" }}>Never its value.</span>
        </div>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", paddingTop: 24, borderTop: "1px solid rgba(23,23,22,.18)", fontSize: 20, color: "#66645f" }}>
        <span>macOS Keychain · per-caller approval · runtime injection</span>
        <span style={{ color: "#c68d00", fontWeight: 700 }}>keykeeper.dev</span>
      </div>
    </div>,
    size,
  );
